...
public class FORM {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		WebElement textstate = driver
				.findElement(By.xpath("//div[@id='state']//div[contains(@class,'-indicatorContainer')]"));
		textstate.click();
		Thread.sleep(3000);
		...
		WebElement textcity = driver
				.findElement(By.xpath("//div[@id='city']//div[contains(@class,'-indicatorContainer')]"));
		textcity.click();
		Thread.sleep(3000);
